...
const client = new OpenAI({
  apiKey: process.env.NEXT_PUBLIC_OPEN_AI_KEY, // OpenAI key
});
...
- Use the provided context ONLY for CoachLume-related questions.
- For general questions NOT related to CoachLume, answer using your full AI knowledge.
- If the user asks something specifically about CoachLume AND the answer is not in context, then say:
"I'm not sure, please check the CoachLume dashboard."
