...
const Feedback = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6">
      <h1 className="text-3xl font-bold mb-2 text-gray-800">Expert Feedback</h1>
      <p className="text-gray-500 mb-8">Review feedback provided by experts on your previous sessions</p>
        ...
        <div className="space-y-6">
          {discussionRoomData
            ...
            .map((data, index) => (
              <div
                key={index}
                className="bg-white overflow-hidden rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition duration-300 group"
              >
                <div className="p-5">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="ml-4">
                      <h2 className="text-lg font-semibold text-gray-800 capitalize">{data.topic}</h2>
                  ...
                  <div className="border-t border-gray-100 pt-4 pb-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-xs text-gray-500 font-medium uppercase">Coaching Type</p>
                          <p className="text-gray-700">{data.coachingOption}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                          <p className="text-xs text-gray-500 font-medium uppercase">Expert</p>
                          <p className="text-gray-700">{data.expertName || "Not assigned"}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 px-5 py-3 flex justify-end border-t border-gray-100">
                  <Button 
                    className="bg-white hover:bg-gray-100 text-gray-800 border border-gray-200 flex items-center"
                  >
