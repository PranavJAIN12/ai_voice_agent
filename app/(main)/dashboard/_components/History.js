...
const History = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4 sm:px-6">
      <h1 className="text-3xl font-bold mb-2 text-gray-800">Your Learning History</h1>
      <p className="text-gray-500 mb-8">Review and access your previous lecture sessions</p>
              ...
              >
                <div className="flex p-5 ">
                  ...
                  <div className="ml-4 flex-1">
                    <h2 className="text-lg font-semibold text-gray-800 line-clamp-1 capitalize mb-1">{data.topic}</h2>
