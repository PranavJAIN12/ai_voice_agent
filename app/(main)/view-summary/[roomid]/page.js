    ...
    <div className="container mx-auto px-4 sm:px-6 py-6 md:py-8">
      <div className="outer-header flex flex-row justify-between">
        ...
        <div className="w-16 h-16 rounded-lg overflow-hidden bg-gray-50">
          ...
          <h1 className="text-lg sm:text-xl font-semibold">{viewSummaryData?.topic}</h1>
          <h1 className="text-lg sm:text-xl font-semibold">{viewSummaryData?.coachingOption}</h1>
        </div>
        </div>
      ...
      <div className="main-content mt-9 flex justify-between flex-row gap-4">
        ...
        <div className="chatbox">
          <div className="bg-green-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl p-6 shadow-sm">
          <h2 className="text-lg font-semibold mb-3 text-blue-800 dark:text-blue-400 flex items-center"> <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2"
                  fill="none"
                  viewBox="0 0 24 24"
